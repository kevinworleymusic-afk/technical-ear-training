...
- **Exercise settings:** Pink noise with Q = 8. Endpoint sets used 63/125/250 Hz and 4/8/16 kHz. The full central-range test used one boosted band per trial across 250 Hz–8 kHz. Focused subdivisions used 250/500/1 kHz, 2/4/8 kHz, 2/4/8/16 kHz, and 1/2/4/8/16 kHz.
...
- **Audible cues used:** Most bands were identifiable at +6 dB. Both endpoints were identifiable at +9 dB; 16 kHz was subsequently audible at +6 dB, while 63 Hz was not reliably audible at +6 dB. Across the full central range, +3 dB boosts were identified at 74%. Focused +3 dB results were 64% for 250 Hz–1 kHz, 97% for 2–8 kHz, 98% for 2–16 kHz, and an estimated 87% for the added 1–16 kHz continuation. During the expanded upper-range block, the listener perceived a distinct difference between the 8 kHz and 16 kHz boosts.
- **Procedure followed consistently:** In progress
- **Adjustment for the next session:** Continue focused 250/500/1 kHz practice at +3 dB, including a fresh block with enough 1 kHz presentations to evaluate that band. Confirm the strong upper-range results in a fresh session while keeping Q = 8 and monitoring fixed at a comfortable level.
