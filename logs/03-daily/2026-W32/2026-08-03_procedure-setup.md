...
- **Exercise settings:** Pink noise with Q = 8. Endpoint sets used 63/125/250 Hz and 4/8/16 kHz. The full central-range test used one boosted band per trial across 250 Hz–8 kHz. Focused subdivisions used 250/500/1 kHz and 2/4/8 kHz.
...
- **Audible cues used:** Most bands were identifiable at +6 dB. Both endpoints were identifiable at +9 dB; 16 kHz was subsequently audible at +6 dB, while 63 Hz was not reliably audible at +6 dB. Across the full central range, +3 dB boosts were identified at 74%. At +3 dB, the focused low-mid set produced 64%, while the focused 2–8 kHz set produced 97%.
- **Procedure followed consistently:** In progress
- **Adjustment for the next session:** Continue focused 250/500/1 kHz practice at +3 dB and confirm the 2/4/8 kHz result in a fresh session. Then recombine the ranges for another 250 Hz–8 kHz test. Keep Q = 8 and monitoring fixed at a comfortable level.
