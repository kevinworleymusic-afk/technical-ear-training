...
- **Audible cues used:** Most bands were identifiable at +6 dB. Both endpoints were identifiable at +9 dB; 16 kHz was subsequently audible at +6 dB, while 63 Hz was not reliably audible at +6 dB. Across the full central range, +3 dB boosts were identified at 74%. Focused +3 dB results were 64% for 250 Hz–1 kHz, 93% for 1–4 kHz, 97% for 2–8 kHz, 98% for 2–16 kHz, and an estimated 87% for the added 1–16 kHz continuation. During the expanded upper-range block, the listener perceived a distinct difference between the 8 kHz and 16 kHz boosts.
- **Procedure followed consistently:** In progress
- **Adjustment for the next session:** Continue focused 250/500/1 kHz practice at +3 dB. Confirm the strong 1–4 kHz and upper-range results in a fresh session, then recombine the ranges for a full-range test while keeping Q = 8 and monitoring fixed at a comfortable level.
