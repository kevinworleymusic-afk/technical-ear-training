...
This dashboard summarizes measurable progress through the available software chapters. Update it after each session or at the end of each training week.
...
### Equalization, pink noise

- **+12 dB boost:** 90% (100 trials)
...
- **Reverberation:** exploratory practice only; no scored assessment
...
**Status key:** ✅ comfortable checking off for the specific sound material practiced; ◐ close, but not fully checked off yet; ☐ not yet checked off.
