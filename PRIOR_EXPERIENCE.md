...
| Measurement and analysis | Audio Precision testing, Studer tape-machine comparison, REW room analysis, MATLAB DSP work, and Python audio-analysis development | Connecting subjective observations with repeatable measurements and technical interpretation |
...
- A graduate independent study using a jazz ensemble and a 2L Cube-inspired microphone approach for 7.1.4 reproduction in Ocean Way Nashville Studio A
...
I also completed a study examining trained listeners' detection of frequency-response boosts through loudspeakers versus headphones. Together, these activities provided exposure to both research participation and the design and interpretation of critical-listening work.
